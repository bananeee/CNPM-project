class SceneChild2 extends Phaser.Scene {
    ...
    gameSetup() {
        ...
        // Hiển thị thời gian
        if (this instanceof SceneChild2D)
            this.timeText = ["7:30", "8:00", "8:30", "13:00", "14:30", "16:00", "19:00", "21:00"];
        else
            this.timeText = ["7:30", "8:00", "10:00", "12:30", "14:00", "17:30", "19:00", "21:00"];
        for (let i = 0; i <= 7; i++) {
    ...
    cardSetup() {
        ...
        for (let i = 0; i <= 7; i++) {
            if (this instanceof SceneChild2D) {
                arrayCardsCorrect.push(this.add.image(this.coordinateImage.x[i], this.coordinateImage.y[i], 'actionD' + i)
                    .setState(i)
